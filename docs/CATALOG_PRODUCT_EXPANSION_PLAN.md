...
| Rebel Kayaks       | _(existing ILAGA)_               |
...
| Intex             | Excursion Pro K2 _(verify image quality)_ |
| Sevylor           | Yukon _(if PDP usable)_                   |
| Grabner           | Holiday 2 _(premium EU)_                  |
| Gumotex           | Thaya                                     |
...
| Palm         | Sport PFD                                    |
| NRS          | cRUSH PFD                                    |
| Yakima       | JayLow _(roof rack)_                         |
| HIKO         | Sprayskirt _(verify size variants as 1 SKU)_ |
...
| Robens                             | Nevis 2                    |
| Robens                             | Kiowa                      |
| Naturehike                         | Cloud Up 3 _(expand line)_ |
| Naturehike                         | Vik 2                      |
...
| _(existing Naturehike Cloud-up 2)_ |
...
| MSR           | Tyvek Footprint _(tent accessory — OK here)_ |
...
| Manufacturer   | Model                              |
| -------------- | ---------------------------------- |
| Fjällräven     | Nikka Shorts Curved Women _(move)_ |
| Patagonia      | Pack Out Tights Women _(move)_     |
