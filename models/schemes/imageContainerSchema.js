...
const imageContainerSchema = new mongoose.Schema({
  ...
  small: {
    ...
    required: [true, 'Image must have a small version. Recommended dimensions are 500 x 500.'],
  },
  thumbnail: {
    type: imageSchema, // 200x200
    required: [true, 'Image must have a thumbnail version. Recommended dimensions are 200 x 200.'],
  },
});
